...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Invoice Client </h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Reports</li>
                        <li class="breadcrumb-item active">Invoice Client</li>
                    </ol>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class=" float-sm-right mt-lg-3">
                        <button class="btn btn-primary rounded-pill" data-toggle="modal" data-target="#inputInvoiceSangati">Input Invoice Sangati</button>
                        <button class="btn btn-warning rounded-pill" data-toggle="modal" data-target="#inputInvoice">Input Invoice</button>
                    </ol>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <table id="timesheetTable" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>11</td>
                                    <td>0</td>
                                    <td> Payment Claim Untuk DODO</td>
                                    <td><a href="" class="btn btn-primary" data-toggle="modal" data-target="#updateInvoice"><i class="fas fa-edit"></i></a></td>
